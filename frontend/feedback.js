...
export function showPageNotice({
    ...
    noticeHost.innerHTML = `
        <div class="page-notice page-notice-${normalizedTone}" role="status">
          ...
          ${actionHtml}
          <button type="button" class="page-notice-close" aria-label="关闭" data-page-notice-close><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M6 6l12 12M6 18L18 6"/></svg></button>
        </div>
    `
