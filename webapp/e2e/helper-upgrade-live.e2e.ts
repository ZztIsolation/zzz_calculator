...
test("public Helper 1.2.1 upgrades transactionally and resumes Scanner 1.0.49 preparation", async ({ page }) => {
  ...
  await expect(page.getByText("Helper 1.3.1 · Scanner 1.0.49 · 后台运行", { exact: true }))
