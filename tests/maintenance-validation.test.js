...
assertInvalid("agents", missingFormulaField, "valueSource.fields[1][1]")
const duplicateFormulaField = clone(formulaScalingAgent)
duplicateFormulaField.combatBuffs.corePassive.effects[0].valueSource.fields = ["attackPercentage", "attackPercentage"]
assertInvalid("agents", duplicateFormulaField, "倍率字段不能重复")
const invalidPanelFormulaSource = clone(formulaScalingAgent)
invalidPanelFormulaSource.combatBuffs.corePassive.effects[0].source.stat = "unknownPanelStat"
assertInvalid("agents", invalidPanelFormulaSource, "source.stat")
const invalidPanelFormulaSourceUnit = clone(formulaScalingAgent)
invalidPanelFormulaSourceUnit.combatBuffs.corePassive.effects[0].source.valueUnit = "displayText"
assertInvalid("agents", invalidPanelFormulaSourceUnit, "source.valueUnit")
